var productList = [
    ...
    $(document).ready(function () {
        ...
        $("#featured").append("<img id='featImg' src='Soras_keyblade.jpg'>");
        $("#featured").append("<div id='featInfo'> <h1 id='featLine2'>Sora's Keyblade</h1> <p id='featLine3'>A mysterious weapon that apparently also opens a lot of doors!</p> <p id='prices'>$19.50</p> <button id='buyNow'>BUY NOW</button> </div>");
