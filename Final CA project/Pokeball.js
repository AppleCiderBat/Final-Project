var productList = [
    ...
    $(document).ready(function () {
        ...
        $("#featured").append("<img id='featImg' src='pokeball.jpg'>");
        $("#featured").append("<div id='featInfo'> <h1 id='featLine2'>Pok&eacute;ball</h1> <p id='featLine3'>Nice try, but this only works on our world's animals.</p> <p id='prices'>$8.50</p> <button id='buyNow'>BUY NOW</button> </div>");
