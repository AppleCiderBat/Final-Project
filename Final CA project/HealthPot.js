var productList = [
    ...
    $(document).ready(function () {
        ...
        $("#featured").append("<img id='featImg' src='minecraft_healing_potion.jpg'>");
        $("#featured").append("<div id='featInfo'> <h1 id='featLine2'>Health potion</h1> <p id='featLine3'>Yup!  With this, you can instantly heal any injury!</p> <p id='prices'>$12.00</p> <button id='buyNow'>BUY NOW</button> </div>");
