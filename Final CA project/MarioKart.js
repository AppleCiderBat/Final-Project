var productList = [
    ...
    $(document).ready(function () {
        ...
        $("#featured").append("<img id='featImg' src='Marios_go-kart.jpg'>");
        $("#featured").append("<div id='featInfo'> <h1 id='featLine2'>Mario's go-kart</h1> <p id='featLine3'>Race to your heart's content in this!</p> <p id='prices'>$40.00</p> <button id='buyNow'>BUY NOW</button> </div>");
