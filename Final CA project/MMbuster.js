var productList = [
    ...
    $(document).ready(function () {
        ...
        $("#featured").append("<img id='featImg' src='MegaMan_megabuster.jpg'>");
        $("#featured").append("<div id='featInfo'> <h1 id='featLine2'>Mega Man's Mega Buster</h1> <p id='featLine3'>No need to be a robot!  Just slip this on and viola!  You are literally ARMED!</p> <p id='prices'>$15.00</p> <button id='buyNow'>BUY NOW</button> </div>");
