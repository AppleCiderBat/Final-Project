var productList = [
    ...
    $(document).ready(function () {
        ...
        $("#featured").append("<img id='featImg' src='Blue_shell.png'>");
        $("#featured").append("<div id='featInfo'> <h1 id='featLine2'>The Blue Shell</h1> <p id='featLine3'>This weapon of mass frustration to those in first place is now available to take home!<br>We do, however, advise you to only use this during races.</p> <p id='prices'>$13.50</p> <button id='buyNow'>BUY NOW</button> </div>");
