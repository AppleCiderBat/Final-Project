var productList = [
    ...
    $(document).ready(function () {
        ...
        $("#featured").append("<img id='featImg' src='diamond_pickaxe.jpg'>");
        $("#featured").append("<div id='featInfo'> <h1 id='featLine2'>Diamond pickaxe</h1> <p id='featLine3'>With this, you can pretty much mine anything (except bedrock; side effect of the game code).</p> <p id='prices'>$25.00</p> <button id='buyNow'>BUY NOW</button> </div>");
