var productList = [
    ...
    $(document).ready(function () {
        ...
        $("#featured").append("<img id='featImg' src='Sans_jacket.jpg'>");
        $("#featured").append("<div id='featInfo'> <h1 id='featLine2'>Sans' jacket</h1> <p id='featLine3'>FIGHT off the BONE-CHILLING cold with this jacket!</p> <p id='prices'>$12.99</p> <button id='buyNow'>BUY NOW</button> </div>");
