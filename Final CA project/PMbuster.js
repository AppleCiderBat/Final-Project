var productList = [
    ...
    $(document).ready(function () {
        ...
        $("#featured").append("<img id='featImg' src='Protomans_megabuster.jpg'>");
        $("#featured").append("<div id='featInfo'> <h1 id='featLine2'>Proto Man's Buster</h1> <p id='featLine3'>No need to be a robot!  Just slip this on and viola!  You are literally ARMED!</p> <p id='prices'>$18.50</p> <button id='buyNow'>BUY NOW</button> </div>");
