var productList = [
    ...
    $(document).ready(function () {
        ...
        $("#featured").append("<img id='featImg' src='Jets_EG.png'>");
        $("#featured").append("<div id='featInfo'> <h1 id='featLine2'>Jet's Extreme Gear</h1> <p id='featLine3'>Your very own hoverboard!</p> <p id='prices'>$30.00</p> <button id='buyNow'>BUY NOW</button> </div>");
