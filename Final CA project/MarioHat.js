var productList = [
    ...
    $(document).ready(function () {
        ...
        $("#featured").append("<img id='featImg' src='Marios_hat.jpg'>");
        $("#featured").append("<div id='featInfo'> <h1 id='featLine2'>Mario's hat</h1> <p id='featLine3'>Now you can rock this classic character's look yourself!</p> <p id='prices'>$10.50</p> <button id='buyNow'>BUY NOW</button> </div>");
