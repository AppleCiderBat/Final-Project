var productList = [
    ...
    $(document).ready(function () {
        ...
        $("#featured").append("<img id='featImg' src='MegaMan_helmet.jpg'>");
        $("#featured").append("<div id='featInfo'> <h1 id='featLine2'>Mega Man's helmet</h1> <p id='featLine3'>Quality head protection from the blue bomber himself!</p> <p id='prices'>$15.00</p> <button id='buyNow'>BUY NOW</button> </div>");
