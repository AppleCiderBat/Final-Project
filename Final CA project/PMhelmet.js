var productList = [
    ...
    $(document).ready(function () {
        ...
        $("#featured").append("<img id='featImg' src='Protomans_helmet.jpeg'>");
        $("#featured").append("<div id='featInfo'> <h1 id='featLine2'>Proto Man's helmet</h1> <p id='featLine3'>Quality head protection from the blue bomber's brother himself!</p> <p id='prices'>$20.00</p> <button id='buyNow'>BUY NOW</button> </div>");
