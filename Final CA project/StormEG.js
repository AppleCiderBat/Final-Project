var productList = [
    ...
    $(document).ready(function () {
        ...
        $("#featured").append("<img id='featImg' src='Storms_EG.png'>");
        $("#featured").append("<div id='featInfo'> <h1 id='featLine2'>Storm's Extreme Gear</h1> <p id='featLine3'>Your very own hoverboard!</p> <p id='prices'>$26.00</p> <button id='buyNow'>BUY NOW</button> </div>");
