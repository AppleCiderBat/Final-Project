var productList = [
    ...
    $(document).ready(function () {
        ...
        $("#featured").append("<img id='featImg' src='enderpearl.jpg'>");
        $("#featured").append("<div id='featInfo'> <h1 id='featLine2'>Enderpearl</h1> <p id='featLine3'>A one-time use instant teleporter, just like in the game!  Make sure you have good aim though...</p> <p id='prices'>$11.00</p> <button id='buyNow'>BUY NOW</button> </div>");
